...
from .serializers import FlightSerializer, BookingSerializer, BookingDetailsSerializer, UpdateBookingSerializer, RegisterBookingSerializer
...
class RegisterView(CreateAPIView):
	serializer_class = RegisterBookingSerializer
